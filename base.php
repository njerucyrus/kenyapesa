...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
<?php
include "views/layouts/head.inc.php";
?>
    </head>
    <body data-spy="scroll" data-target=".navbar" data-offset="200">
        ...
        <div class="culmn">
            <header id="main_menu" class="header navbar-fixed-top">            
                <?php
                include "views/layouts/navbar.inc.php";
                ?>
            ...
            <section id="home" class="home">
                <?php
                include "views/layouts/home.inc.php";
                ?>
            </section>
            ...
            <section id="service" class="service">
                <?php
                include "views/layouts/services.inc.php";
            ...
            <section id="about" class="about">
                <?php
                include "views/layouts/about.inc.php";
                ?>
            </section>
            ...
            <section id="choose" class="choose">
                <?php
                include "views/layouts/why_choose_us.inc.php";
                ?>
            </section>
            ...
            <section id="testimonial" class="testimonial">
                <?php
                include "views/layouts/testimonial.inc.php";
                ?>
            </section>
...
<div id="footers">
    ...
    <?php
    include "views/layouts/footer.inc.php";
    ?>
</div>
