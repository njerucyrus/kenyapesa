                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    if ($merchant['status'] == 0) {
                                        ...
                                        <button id="btn-update" onclick="editEmail('<?php echo $merchant['id']?>','<?php echo $merchant['merchant_email']?>')" class="btn btn-xs btn-primary" style="font-size: 1.0em;"><span><i class="fa fa-edit"></i></span>&nbsp;Update</button>
        ...
        $.ajax(
            {
                type: 'POST',
                url: url,
                data: {'option': 'update', 'email': editedEmail, 'id':id },
                dataType: 'json',
                success: function (response) {
                    if(response.statusCode == 200) {
                        $('#feedback')
        ...
        $.ajax(
            {
                type: 'POST',
                url: url,
                data: {'option': 'create', 'email': editedEmail },
                dataType: 'json',
                success: function (response) {
                    if(response.statusCode == 200) {
                        $('#feedback')
